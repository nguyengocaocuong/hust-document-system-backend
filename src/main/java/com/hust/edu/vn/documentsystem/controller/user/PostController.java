...
public class PostController {
    ...
    @Autowired
    public PostController(PostService postService, FavoritePostService favoritePostService, ModelMapperUtils modelMapperUtils) {
        this.postService = postService;
        this.favoritePostService = favoritePostService;
        this.modelMapperUtils = modelMapperUtils;
    }
    // TODO: giữ lại các api trong đoạn này
    @GetMapping()
    public ResponseEntity<CustomResponse> getAllPosts(@RequestParam(value = "page", required = false, defaultValue = "0") int page, @RequestParam(value = "size", required = false, defaultValue = "8") int size){
